...
public class DiscussremenjingdianController {
    ...
    public R save(@RequestBody DiscussremenjingdianEntity discussremenjingdian, HttpServletRequest request){
    	discussremenjingdian.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussremenjingdianEntity> wrapper = new EntityWrapper<DiscussremenjingdianEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussremenjingdianService.selectCount(wrapper);
